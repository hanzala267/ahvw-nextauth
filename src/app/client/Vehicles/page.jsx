...
const vehicles = [
  ...
  { id: "dajd7hdy", name: "Vehicle 2", overdue: false },
  { id: "eajd8hez", name: "Vehicle 3", overdue: true },
...
const CustomerVahicle = () => {
  ...
  useEffect(() => {
    // Simulate fetching overdue services notifications
    const overdueNotifications = vehicles
      .filter((vehicle) => vehicle.overdue)
